...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr diffuse = Texture2D::LoadFromFile("images/grass.jpg");
		...
		Texture2D::sptr flag = Texture2D::LoadFromFile("images/nkflag.png");
		...
		GameObject obj2 = scene->CreateEntity("wall");
		{
		...
		GameObject obj4 = scene->CreateEntity("tankRight");
		{
			// Build a mesh
		...
		GameObject obj5 = scene->CreateEntity("tankUp");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/tank.obj");
		...
		GameObject obj6 = scene->CreateEntity("tankLeft");
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/tank.obj");
